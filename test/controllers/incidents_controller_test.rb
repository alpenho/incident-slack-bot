...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference("Incident.count") do
      post incidents_url, params: { incident: { description: @incident.description, severity: @incident.severity, title: @incident.title } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { description: @incident.description, severity: @incident.severity, title: @incident.title } }
